...
const zhCNMessages = {
  ...
  changelog1511: '修复批量管理中全选失效的问题，全选状态显示更准确',
  changelog1512: '批量管理条支持点击切换全选，设置页分段选择器切换更顺滑',
...
const enUSMessages: Record<keyof typeof zhCNMessages, string> = {
  ...
  changelog1511: 'Fix the broken select-all in batch management and show its state correctly',
  changelog1512: 'Make the batch bar count clickable to toggle select-all, and smooth the settings segmented control',
