...
const zhCNMessages = {
  ...
  bugFixes: '问题修复：',
  etc: '其他：',
  changelog1331: '修复多窗口场景下标签页可能被移动到其他窗口的问题',
  changelog1332: '恢复关闭标签页时保留标签页原来所在的窗口',
  changelog1321: '支持将本地文件标签页自动归入“本地文件”分组',
...
const enUSMessages: Record<keyof typeof zhCNMessages, string> = {
  ...
  bugFixes: 'Bug fixes:',
  etc: 'Other:',
  changelog1331: 'Fix tabs potentially moving to another window when multiple browser windows are open',
  changelog1332: 'Restore closed tabs to their original browser window',
  changelog1321: 'Automatically group local file tabs into a Local file group',
